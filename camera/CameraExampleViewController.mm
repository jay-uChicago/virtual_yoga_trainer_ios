...
static NSString* labels_file_name = @"yoga101_labels";
static NSString* labels_file_type = @"txt";
// These dimensions need to match those the model was trained with.
const int wanted_input_width = 64;
const int wanted_input_height = 64;
const int wanted_input_channels = 3;
const float input_mean = 128.0f;
const float input_std = 128.0f;
const std::string input_layer_name = "InputData/X";
const std::string output_layer_name = "FullyConnected/Softmax";
